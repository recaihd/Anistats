   const socket = io(window.location.origin);
    ...
    socket.on('fimBatalha', r => {
        ...
        if (venci) {
            title.innerText = "VITÓRIA"; title.className = "result-title win-text";
            change.innerText = "GANHOU +50"; change.style.color = "#10b981";
        } else {
            title.innerText = "DERROTA"; title.className = "result-title lose-text";
            change.innerText = "PERDEU -25"; change.style.color = "#ef4444";
        }
    });